...
class WeatherLookup:
    def __init__(self, state, parameters):
        ...
        self.lat_length = len(
            self.wind_temp_data.variables['latitude'])  # Length of latitude dimension - number of cells
        self.lon_length = len(
            self.wind_temp_data.variables['longitude'])  # Length of longitude dimension - number of cells
