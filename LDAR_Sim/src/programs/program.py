...
class Program:
    ...
    def __init__(self, state, methods: dict, sites: list[Site],
        sim_start_date: date, sim_end_date: date, consider_weather : bool) -> None:
        self._methods: list[Method] = [
            Method(method, properties, consider_weather) for method, properties in methods.items()
        ]
