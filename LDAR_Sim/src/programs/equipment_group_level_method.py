...
from sensors.sensor_constant_mapping import ERR_MSG_UNKNOWN_SENS_TYPE, SENS_MDL, SENS_QE, SENS_TYPE


class EquipmentGroupLevelMethod(SiteLevelMethod):
    MEASUREMENT_SCALE = "equipment"

    def __init__(self, name, properties, follow_up_schedule: FollowUpMobileSchedule):
        super().__init__(name, properties, follow_up_schedule)
