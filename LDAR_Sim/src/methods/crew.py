...
class BaseCrew:
    ...
    def gen_site_vis_rec(self, site_detect_results, site) -> Dict[str, Any]:
        ...
        for leak in site_vis_rec["leaks_at_site"]:
            if any(
                dictionary.get("leak_ID") == leak["leak_ID"]
