...
bb = [
    str(ceil(facilities["lat"].max())),
    str(floor(facilities["lon"].min())),
    str(floor(facilities["lat"].min())),
    str(ceil(facilities["lon"].max())),
]
...
c.retrieve(
    ...
    r"ERA5_{}_{}_{}.nc".format(start_year, end_year, region_name),
