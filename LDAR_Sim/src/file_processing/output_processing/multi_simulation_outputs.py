...
TS_SUMMARY_COLUMNS = [
    ...
    TS_SUMMARY_COLUMNS_ACCESSORS.TOTAL_COST,
...
def get_count(df: pd.DataFrame, column: str) -> int:
...
TS_MAPPING_TO_SUMMARY_COLS = {
    ...
    TS_SUMMARY_COLUMNS_ACCESSORS.TOTAL_COST: lambda df: get_sum(df, tca.COST),
