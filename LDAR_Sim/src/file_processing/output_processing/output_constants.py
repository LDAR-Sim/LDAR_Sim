...
EMIS_ESTIMATION_SUMMARY_FILENAME = "emissions_estimation_summary_stats.csv"
...
class EMIS_ESTIMATION_SUMMARY_COLUMNS_ACCESSORS:
    PROG_NAME = "Program Name"
    SIM = "Simulation"
    YEAR = "Year"
    ANNUAL_EMISSIONS = "Annual Estimated Emissions (Kg Methane)"


class EMIS_SIMPLE_SUMMARY_COLUMNS_ACCESSORS:
    PROG_NAME = "Program Name"
    SIM = "Simulation"
    YEAR = "Year"
    ANNUAL_EMISSIONS = "Annual Emissions (Kg Methane)"
...
EMIS_ESTIMATION_SUMMARY_COLUMNS = [
    EMIS_ESTIMATION_SUMMARY_COLUMNS_ACCESSORS.PROG_NAME,
    EMIS_ESTIMATION_SUMMARY_COLUMNS_ACCESSORS.SIM,
    EMIS_ESTIMATION_SUMMARY_COLUMNS_ACCESSORS.YEAR,
    EMIS_ESTIMATION_SUMMARY_COLUMNS_ACCESSORS.ANNUAL_EMISSIONS,
]

EMIS_SIMPLE_SUMMARY_COLUMNS = [
    EMIS_SIMPLE_SUMMARY_COLUMNS_ACCESSORS.PROG_NAME,
    EMIS_SIMPLE_SUMMARY_COLUMNS_ACCESSORS.SIM,
    EMIS_SIMPLE_SUMMARY_COLUMNS_ACCESSORS.YEAR,
    EMIS_SIMPLE_SUMMARY_COLUMNS_ACCESSORS.ANNUAL_EMISSIONS,
]
