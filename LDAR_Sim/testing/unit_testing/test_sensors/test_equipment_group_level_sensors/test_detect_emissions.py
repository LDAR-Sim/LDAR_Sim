...
from testing.unit_testing.test_sensors.test_equipment_group_level_sensors.equipment_group_level_sensors_testing_fixtures import (  # noqa
    mock_site_emis_for_eqg_level_detect_emissions_testing_fix,
    mock_site_emis_for_eqg_level_detect_emissions_testing_lower_emis_fix,
    mock_site_for_eqg_level_detect_emissions_testing_fix,
    mock_site_for_eqg_level_detect_emissions_testing_lower_emissions_fix,
    sensor_info_for_default_eqg_level_sensor_construction_testing_fix,
    sensor_info_high_mdl_for_default_eqg_level_sensor_testing_fix,
    mock_site_emis_for_eqg_level_detect_emissions_testing_mixed_detect_fix,
    mock_site_for_eqg_level_detect_emissions_testing_mixed_detect_fix,
)
...
def test_000_default_eqg_level_sensor_detect_emissions_detects_emissions_at_site_if_combined_rate_above_mdl(  # noqa
    sensor_info_for_default_eqg_level_sensor_construction_testing: dict[str, int],
    mock_site_for_eqg_level_detect_emissions_testing,
) -> None:
    mock_site: Site = Site()
    ...
    expected_eqg_srv_results = mock_site_for_eqg_level_detect_emissions_testing[2]
...
def test_000_default_eqg_level_sensor_detect_emissions_does_not_detect_emissions_at_site_if_combined_rate_below_mdl(  # noqa
    sensor_info_high_mdl_for_default_eqg_level_sensor_testing,
    mock_site_for_eqg_level_detect_emissions_testing_lower_emissions,
) -> None:
    mock_site: Site = Site()
    ...
    expected_measured_emis = mock_site_for_eqg_level_detect_emissions_testing_lower_emissions[2]
    expected_eqg_srv_results = mock_site_for_eqg_level_detect_emissions_testing_lower_emissions[3]
...
def test_000_default_eqg_level_sensor_detect_emissions_correctly_detects_only_emissions_at_eqgs_above_MDL(  # noqa
    sensor_info_high_mdl_for_default_eqg_level_sensor_testing,
    mock_site_for_eqg_level_detect_emissions_testing_mixed_detect,
) -> None:
    mock_site: Site = Site()
    mdl: float = sensor_info_high_mdl_for_default_eqg_level_sensor_testing["mdl"]
    qe: float = sensor_info_high_mdl_for_default_eqg_level_sensor_testing["QE"]
    ...
    expected_measured_emis = mock_site_for_eqg_level_detect_emissions_testing_mixed_detect[2]
    expected_eqg_srv_results = mock_site_for_eqg_level_detect_emissions_testing_mixed_detect[3]
    assert emis_detected
    assert expected_true_emis == approx(report.site_true_rate)
    assert expected_measured_emis == approx(report.site_measured_rate)
    assert len(expected_eqg_srv_results) == len(report.equipment_groups_surveyed)
