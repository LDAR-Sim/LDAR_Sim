...
def test_042_initialize_leaks(mock_site_for_leak_test, mock_vw, mock_site_return_test, mocker):
...
def test_042_initialize_leaks_2(mock_site_for_leak_test, mock_vw_2, mock_site_return_test, mocker):
    mocker.patch("src.initialization.leaks.random.binomial", return_value=1)
    mocker.patch("src.initialization.leaks.random.randint", return_value=0)
