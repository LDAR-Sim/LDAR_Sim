...
def mock_vw_for_ldar_sim_testing_1_fix():
    return {
        "emissions": {"leak_file": None, "max_leak_rate": 100000},
        "subtype_file": None,
        "pregenerate_leaks": True,
        "initial_leaks": [
            [{"tagged": True, "tagged_by_company": "natural", "day_ts_began": -1, "rate": 1}]
        ],
        "timesteps": 2,
    }
...
def mock_program_params_for_ldar_sim_testing_1_fix():
    return {"economics": {"repair_costs": {"file": None, "vals": [200.0]}}, "methods": {}}
...
def mock_vw_for_ldar_sim_testing_2_fix():
    return {
        "emissions": {"leak_file": None, "max_leak_rate": 100000, "consider_venting": False},
        "subtype_file": None,
        "pregenerate_leaks": True,
        "initial_leaks": [
            [
...
def mock_state_for_ldar_sim_testing_2_fix(mocker):
    ...
    return {
        ...
        "sites": [
            {
                "active_leaks": {"tagged": True, "estimated_date_began": 0},
                "subtype_code": None,
                "facility_ID": 0,
                "lat": 55.05,
                "lon": -119.99,
