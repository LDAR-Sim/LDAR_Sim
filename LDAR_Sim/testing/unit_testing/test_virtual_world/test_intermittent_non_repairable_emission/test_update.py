...
def test_update_correctly_changes_emitting_state_when_on_emitting_to_non_emitting_boundary(
    ...
    emission_active_duration: int = intermittent_non_repairable_emission_creation_params[
        "active_duration"
    ]
...
def test_update_correctly_changes_emitting_state_when_on_non_emitting_to_emitting_boundary(
    ...
    emission_inactive_duration: int = intermittent_non_repairable_emission_creation_params[
        "inactive_duration"
    ]
