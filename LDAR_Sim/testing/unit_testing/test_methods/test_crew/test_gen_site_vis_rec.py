...
def test_052_gen_site_vis_rec_returns_expected_vals(mocker, test_input, expected,
    ...
    crew = BaseCrew(mock_state_for_crew_testing_1, mock_params_for_crew_testing_1,
                    mock_config_for_crew_testing_1, None, None, test_input[2], None)
