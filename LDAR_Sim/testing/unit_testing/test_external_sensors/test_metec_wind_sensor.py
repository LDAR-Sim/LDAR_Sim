...
from testing.unit_testing.test_external_sensors.external_sensor_testing_fixtures import (  # Noqa: 401
    ...
    mock_site_dict_for_sensor_return_5_fix,
    ...
    mock_state_for_sensor_testing_2_fix,
    mock_site_for_crew_testing_fix,
...
def test_093_detect_emissions_simple_component(
    ...
    result: dict = detect_emissions(
        crew,
        mock_site_for_crew_testing,
        mock_site_for_crew_testing["active_leaks"],
        [3],
        3,
        3,
        0,
    ...
    expected: dict = mock_site_dict_for_sensor_return_5
    assert result == expected
