...
def mock_config_for_sensor_testing_1_fix() -> "dict[str, Any]":
    """
    Config for a site level sensor, lower MDL - No wind
    """
    return {
...
def mock_site_dict_for_sensor_return_1_fix() -> Dict[str, Any]:
    """
    Expected return value for a simple site dictionary for sensor testing
    """
    return {
        "site": {
            "equipment_groups": 1,
...
def mock_config_for_sensor_testing_2_fix() -> "dict[str, Any]":
    """
    Config for site level sensor with higher MDL - No wind
    """
    return {
        "scheduling": {"LDAR_crew_init_location": [-114.062, 51.044], "route_planning": False},
        "deployment_type": "mobile",
...
def mock_config_for_sensor_testing_3_fix() -> "dict[str, Any]":
    """
    Config for testing site level sensor - Wind
    """
    return {
        "scheduling": {"LDAR_crew_init_location": [-114.062, 51.044], "route_planning": False},
        "deployment_type": "mobile",
...
def mock_site_for_crew_testing_fix() -> "dict[str, Any]":
    return {
        "equipment_groups": 1,
        "active_leaks": [
            {
