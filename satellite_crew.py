...
class satellite_crew:
    def __init__ (self, state, parameters, config, timeseries, deployment_days, id):
        '''
        Constructs an individual satellite crew based on defined configuration.
        '''
        self.state = state
    ...
    def work_a_day (self):
        ...
        work_hours = None
        max_work = self.parameters['methods']['satellite']['max_workday']
        ...
        if work_hours < 24 and work_hours != 0:
            ...
            print('Unreasonable number of work hours specified for satellite crew ' + str(self.crewstate['id']))
        ...
        if self.worked_today == True:
            self.timeseries['satellite_cost'][self.state['t'].current_timestep] += self.parameters['methods']['satellite']['cost_per_day']
    ...
    def choose_site (self):
        ...
        for site in self.state['sites']:
            ...
            if site['attempted_today_satellite?'] == False:
    ...
    def visit_site (self, facility_ID, site):
        ...
        detect = False
        if site_cum_rate > (250000*0.024):  # g/hour to kg/day
            detect = True    
