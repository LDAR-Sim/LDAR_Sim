...
1. Locate the program parameter file associated with the baseline program for your simulation. The paogram name name will match the value set for the baseline_program parameter in the Simulation_settings (Your transformed global parameters file). This will often be set to P_none.
